...
function App() {
  ...
  return (
    <div className={app.app}>
      ...
      <div className={[skyButton.skyButton, sky === 0 ? skyButton.cloudyIcon : app.clearIcon].join(" ")} onClick={() => (sky === 0 ? setSky(1) : setSky(0))}></div>
          
      <img src={mountainBackground} className={[background.background, sky === 0 ? background.lightingClear : background.lightingCloudy].join(" ")} alt="" 
