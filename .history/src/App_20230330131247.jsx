...
function App() {
  ...
  return (
    <div className={app.app}>
      ...
      <img className={app.cursor} style={{ left: cursorCords[1] - 30, top: cursorCords[0] - 50, transitionTimingFunction: "lin" transition: ".5s", transitionDelay: ".1s", rotate: cursorPos ? "0deg" : "180deg" }} src={arrow} alt="" />
