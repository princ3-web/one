...
function App() {
  ...
  return (
    <div className={app.app}>
      ...
      <img className={app.cursor} style={{ left: cursorCords[1] - 30, top: cursorCords[0] - 50, transition: ".02s",transitionDelay: ".2s", rotate: cursorPos ? "0deg" : "180deg" }} src={arrow} alt="" />
