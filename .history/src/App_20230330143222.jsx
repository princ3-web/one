...
function App() {
  ...
  const texts = [
    [
      <>
        <div className={text.sectionContainer}>
          ...
          <div className={[text.text, text.text3, app.selected].join(" ")}>with beautiful designs,</div>
    ...
    [
      <>
        <div className={text.sectionContainer}>
          <div className={[text.text, app.text3].join(" ")}>Web Designer & Developer</div>
          <div className={[text.text, app.text3].join(" ")}>creating custom websites,</div>
          <div className={[text.text, app.text3, app.selected].join(" ")}>with beautiful designs,</div>
          <div className={[text.text, app.text3].join(" ")}>and fast performance.</div>
        </div>
        <div className={text.sectionContainer}>
    ...
    [
      <>
        <div className={app.sectionContainer}>
          <div className={app.text}>My default text</div>
          <div className={app.text}>My default text</div>
          <div className={app.text}>My default text</div>
        </div>
  ...
  return (
    <div className={app.app}>
      ...
      <img className={cursor.cursor} style={{ 
