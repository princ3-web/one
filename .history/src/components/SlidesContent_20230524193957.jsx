...
const experiences = [
  ...
  {text: "Umiejętność rozwiązywania problemów: Wymień przykłady sytuacji, w których musiałeś radzić sobie z trudnościami technicznymi lub rozwiązywać problemy związane z interfejsem użytkownika. Opisz swoje podejście i rezultaty."},
]
