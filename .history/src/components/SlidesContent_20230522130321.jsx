...
const text1 = [
  "I specialize in crafting customized websites designed specifically for individuals and small businesses. You don't have to settle for mediocre choices or generic templates.", "I provide unique designs at affordable prices. Your website plays a vital role in creating a favorable first impression on your customers, so ensuring its excellence is crucial.",  "While I have other commitments that limit my availability, I'm always on the lookout for interesting projects. Take a look at my portfolio below, and if you think we would work well together, please don't hesitate to reach out to me via email."
];
...
const Icons2 = [
  { image: website0, subtitle: "tech company", link:  "https://princ3-web.github.io/five/"},
  { image: website0, subtitle: "fantasy game", link:  "https://princ3-web.github.io/four/"},
      ...
      <div className={slides.iconContainer}>
        {Icons2.map((item) => (
          <div className={slides.icon}>
            <div className={slides.iconImage} alt="" />
