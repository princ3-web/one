...
const Icons2 = [
  { image: window, subtitle: "creative approach to improve work effectiveness" },
  { image: window, subtitle: "collaborative creation of projects designs" },
  { image: window, subtitle: "coherent and logic code" },
  { image: window, subtitle: "flexible approach to new technologies" },
  { image: window, subtitle: "good skills in error fixing and bug-free coding" },
  { image: window, subtitle: "always open to find new possibilities" },
];
