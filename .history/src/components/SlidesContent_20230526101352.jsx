...
const text1 = [
  ...
  {
    icon: "",
    text: "I wish to provide unique designs at affordable prices. Website plays a vital role in creating a favorable first impression on your customers, so striving for superiority is key.",
  },
  {
    icon: "",
