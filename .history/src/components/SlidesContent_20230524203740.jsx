...
import icon0 from "../assets/icons/window.png";
import icon1 from "../assets/icons/goal.png";
import icon2 from "../assets/icons/goal0.png";
import icon3 from "../assets/icons/goal1.png";
...
const text1 = [
  ...
  {
    icon: "",
    text: "I wish to provide unique designs at affordable prices. Your website plays a vital role in creating a favorable first impression on your customers, so striving for superiority is key.",
  },
  {
    icon: "",
...
const SlidesContent = [
  ...
  [
    <div className={slides.sectionContainer} style={{ width: "80%", left: "10%" }}>
      {text1.map((item) => (
        <div style={{ display: "flex", justifyContent:"cent"
         }}>
          <div className={slides.smallIconContainer}>
            <img className={[slides.smallTextIcon]} src={icon2} alt="" />
            <img className={[slides.smallTextIconArrow]} src={icon3} alt="" />
          </div>
  ...
  [
    <div className={slides.sectionContainer} style={{ width: "80%", left: "10%" }}>
      {experiences.map((item) => (
        <div style={{ display: "flex", marginBlock: "0.5rem" }}>
