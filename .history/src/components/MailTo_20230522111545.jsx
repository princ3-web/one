...
import image0 from "../assets/icons/email.png";
import image1 from "../assets/icons/email.png";
import image2 from "../assets/icons/email.png";
...
const MailTo = ({ email, subject, body, children }) => {
  ...
  const contactIcons = [{ image: image, subtitle: "Get in touch with me" }];
