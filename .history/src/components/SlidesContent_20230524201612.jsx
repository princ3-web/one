...
const text1 = [
  {icon:"", text:"I specialize in crafting customized websites designed specifically for individuals and small businesses. My aims are to outshine mediocre choices and embrace extraordinary possibilities beyond generic templates."},
  ...
  [
    <div className={slides.sectionContainer} style={{ width: "80%", left: "10%" }}>
      {experiences.map((item) => (
        <div style={{ display: "flex" }}>
          <img className={[slides.smallTextIcon]} src={icon} alt="" />
