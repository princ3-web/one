...
import mountainBackground from "./assets/images/mountains.png";
  ...
  return (
    <div className={app.app}>
      ...
      <div
        className={[
          skyButton.skyButton,
          sky === 0 ? skyButton.cloudyIcon : skyButton.clearIcon,
        ].join(" ")}
        onClick={() => (sky === 0 ? setSky(1) : setSky(0))}
      ></div>
      ...
      <video
        ...
        src={require("../assets/images/" + Math.floor(Math.random() * 3 + 1) + ".mp4")}
      />
      ...
      {/* <img
        ...
        className={[
          ...
          sky === 0 ? background.lightingClear : background.lightingCloudy,
        ].join(" ")}
        alt=""
        onClick={() =>
          cursorPos
      ...
      {/* <img
        className={[
          ...
          sky === 0 ? background.clear : background.cloudy,
        ].join(" ")}
        alt=""
        onClick={() =>
          cursorPos
