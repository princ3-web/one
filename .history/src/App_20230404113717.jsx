...
function App() {
  ...
  const cursorStyle = { 
    ...
    const cursorDecoration0Style = { 
      left: cursorCords[1] - 0, 
      top: cursorCords[0] - 90, 
      transitionTimingFunction: "ease-out", 
      transition: "1.5s", 
      transitionDelay: ".0s", 
      rotate: cursorPos ? "0deg" : "180deg"}

      const cursorDecoration1Style = { 
        left: cursorCords[1] - 10, 
        top: cursorCords[0] - 115, 
        transitionTimingFunction: "ease-out", 
        transition: "1.1s", 
        transitionDelay: ".0s", 
        rotate: cursorPos ? "0deg" : "180deg"}

        const cursorDecoration2Style = { 
          left: cursorCords[1] - 15, 
          top: cursorCords[0] - 110, 
          transitionTimingFunction: "ease-out", 
          transition: "1.2s", 
          transitionDelay: ".0s", 
          rotate: cursorPos ? "0deg" : "180deg"}
...
<div 
      className={cursor.cursorDecoration} 
      style={cursorDecoration0Style} 
      // src={arrow} 
      alt="" />

<div 
      className={cursor.cursorDecoration} 
      style={cursorDecoration1Style} 
      // src={arrow} 
      alt="" />

<div 
      className={cursor.cursorDecoration} 
      style={cursorDecoration2Style} 
      // src={arrow} 
      alt="" />
